...
{
	uint8_t r = uint8_t(0);
	error = error || pop_uint8_t(r) == false;
	return r;
}
...
inline uint16_t pop_uint16_t(bool& error)
{
	...
	error = error || pop_uint16_t(r) == false;
	return r;
}
...
inline uint32_t pop_uint32_t(bool& error)
{
	...
	error = error || pop_uint32_t(r) == false;
	return r;
}
...
inline uint64_t pop_uint64_t(bool& error)
{
	...
	error = error || pop_uint64_t(r) == false;
	return r;
}
...
{
	int8_t r = int8_t(0);
	error = error || pop_int8_t(r) == false;
	return r;
}
...
{
	int16_t r = int16_t(0);
	error = error || pop_int16_t(r) == false;
	return r;
}
...
{
	int32_t r = int32_t(0);
	error = error || pop_int32_t(r) == false;
	return r;
}
...
{
	int64_t r = int64_t(0);
	error = error || pop_int64_t(r) == false;
	return r;
}
